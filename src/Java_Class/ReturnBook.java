...
//        try {
//            Connection con = ConnectionProvider.getCon();
//            String sql1 = "Select due_date,TIMESTAMPDIFF(DAY,due_date,now()) as fine_days from issue_book_details";
//            Statement st1 = con.createStatement();
//            ResultSet rs1 = st1.executeQuery(sql1);
//            if (rs1.next()) {
//                txt_fine_days.setText(rs1.getString("fine_days"));
//                int fine_days = Integer.parseInt(txt_fine_days.getText());
//
//                if (fine_days <= 0) {
//                    txt_fine_days.setText("0");
...
//  }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btn_find_details, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 550, 330, -1));
        ...
        jPanel1.add(txt_student_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(1180, 430, 220, 30));
        ...
        jPanel1.add(txt_book_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(1180, 350, 220, 30));
        ...
        jPanel1.add(btn_issue_book_return, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 660, 330, -1));
